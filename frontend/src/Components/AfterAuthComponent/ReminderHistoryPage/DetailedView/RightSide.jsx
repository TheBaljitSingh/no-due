...
const RightSide = memo(
  ({ setDetailedView, setSelectedCustomer, imgFor, selectedCustomer }) => {
        ...
        {selectedCustomer ? (
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 flex flex-col h-full overflow-hidden">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-3 space-y-1.5">
                  <div className="flex items-center gap-2 text-sm text-gray-600">
                    ...
                    <span>
                      {formatMobile(selectedCustomer.mobile) || "mobile-1234"}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <div className="grid grid-cols-3 gap-3 mt-6 flex-shrink-0">
              <div className="rounded-lg bg-blue-50 border border-blue-100 p-3">
                ...
                <div className="text-2xl font-semibold text-blue-900 mt-1">
                  {(selectedCustomer?.summary?.totalSent || 0) +
                    (selectedCustomer?.summary?.totalFailed || 0)}
                </div>
              </div>
            ...
            <div className="mt-6 flex-1 min-h-0 flex flex-col">
              <h4 className="text-sm font-semibold text-gray-900 mb-3 flex-shrink-0">
                Reminder Timeline
              </h4>
          ...
          <div className="h-full min-h-[400px] flex flex-col items-center justify-center text-center p-8 bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <p className="text-gray-400 text-xs mt-1">
              to view reminder history and details
            </p>
          </div>
        )}
      </div>
