...
const BulkEntrySection = ({ paymentTerms }) => {
  ...
  const handleDownloadCSVFormat = () => {
    ...
    link.href =
      "https://res.cloudinary.com/dzdt11nsx/raw/upload/fl_attachment:BulkUploadFormat-nodue/v1771663588/Updated_Test_Data_d0br4m.xlsx";
    link.click();
  };
  return (
    <div className="min-w-0 w-full">
      ...
      <div className="flex items-center justify-center w-full mt-6">
        <label
          ...
          className={`relative flex flex-col items-center justify-center w-1/2 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-50 transition-colors group ${isParsing ? "pointer-events-none opacity-60" : ""}`}
        >
          {isParsing && (
      ...
      <div className="flex flex-col-reverse sm:flex-row gap-3 sm:justify-end mt-6">
        ...
        >
          {isParsing ? "Parsing..." : "Preview & Create Entries"}
        </button>
      </div>
