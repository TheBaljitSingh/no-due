...
export default function PaymentTermCreationModal({ editingTerm, handleClose, handleSubmit, loading }) {
        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`px-5 py-2 rounded-xl text-sm bg-green-600 text-white hover:bg-green-700 transition flex items-center gap-2 ${loading ? "opacity-70 cursor-not-allowed" : ""}`}
            >
              {loading ? (
                <>
