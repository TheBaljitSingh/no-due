            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <label className={`relative flex items-center gap-3 px-4 py-3.5 rounded-lg border-2 cursor-pointer transition-all ${channels.includes("whatsapp")
                  ...
                  <label className={`relative flex items-center gap-3 px-4 py-3.5 rounded-lg border-2 cursor-pointer transition-all ${channels.includes("voice")
