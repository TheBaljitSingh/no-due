...
import {
  deleteReminder,
  rescheduleReminder,
} from "../../../utils/service/reminderService";
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6">
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${statusChip(reminder.status)}`}
                      >
                  ...
                  <div>
                    ...
                    <div className="rounded-lg border border-gray-200 p-3 bg-gray-50">
                      <div className="text-sm font-medium text-gray-900">
                        {TEMPLATES[reminder.template]?.label ||
                          reminder.template}
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="rounded-lg border border-gray-200 p-4 bg-gray-50">
                        ...
                        <div className="text-sm text-gray-600">
                          {reminder.lastResult.response || "No response"}
                        </div>
                      </div>
                    </div>
                  )}
