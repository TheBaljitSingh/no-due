...
const LeftSide = memo(
  ({ CustomerNames, selectedCustomer, setSelectedCustomer, imgFor }) => {
    return (
        ...
        {CustomerNames.map((customer, index) => {
          ...
          return (
            <button
              ...
              className={`text-left bg-white border rounded-lg transition-colors duration-200 p-3 flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-green-500 ${
                isActive
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div
                  className={`font-medium truncate ${isActive ? "text-green-900" : "text-gray-900"}`}
                >
                  {customer.name}
                </div>
                <div className="flex items-center gap-2 text-xs text-gray-500 mt-0.5">
                  ...
                  <span className="truncate">
                    Mobile: {formatMobile(customer.mobile) || "mobile-1234"}
                  </span>
                </div>
              </div>
            </button>
