...
const WhatsappConnectivity = () => {
    ...
    const [status, setStatus] = useState(
        user?.whatsapp?.status || "not_connected",
    );
    ...
    //   useEffect(()=>{
    //     setStatus(user?.whatsapp?.status || 'not_connected');
        ...
        if (connected === "true") {
            ...
            const fetchUserData = async () => {
                try {
                    ...
                    // once case will be there if connected to whatsapp but not able to fetch user profile
        ...
        <div className="p-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div
                        className={`px-4 py-2 rounded-full text-sm font-medium ${status === "connected"
                            ...
                            <>
                                <div className="mb-6">
                                    ...
                                    <p className="text-sm text-gray-500 max-w-sm mx-auto">
                                        Link your Meta WhatsApp Business Account to start sending
